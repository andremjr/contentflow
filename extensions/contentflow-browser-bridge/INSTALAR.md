...
Os usuários instalam a ponte manualmente. Scripts de automação usados pelo mantenedor para preparar sua própria máquina são ferramentas locais paralelas e não fazem parte do ContentFlow OS.
