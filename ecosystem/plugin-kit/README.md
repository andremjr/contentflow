...
Os templates ficam em [`templates`](templates/) e um conjunto de respostas reproduzível fica em [`examples`](examples/). O guia completo está em [`../../docs/ecosystem/development.md`](../../docs/ecosystem/development.md).
