...
- [`ARCHITECTURE.md`](../../docs/ARCHITECTURE.md): domínio, processos, blocos e operadores.
- [`LEGAL_AND_LICENSING.md`](../../docs/LEGAL_AND_LICENSING.md): limites jurídicos e política de licenciamento.
