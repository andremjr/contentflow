...
```powershell
npm run plugin:kit -- validate ./plugins/bundled/codex-skill-runner
npm run plugin:kit -- test-contract ./plugins/bundled/codex-skill-runner
npm run plugin:kit -- test-sandbox ./plugins/bundled/codex-skill-runner
npm run plugin:kit -- report ./plugins/bundled/codex-skill-runner
```
