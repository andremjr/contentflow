...
npm run plugin:kit -- test-contract ./plugins/bundled/silence-remover
npm run plugin:kit -- test-sandbox ./plugins/bundled/silence-remover
npm run plugin:kit -- report ./plugins/bundled/silence-remover
npm run plugin:kit -- check ./plugins/bundled/silence-remover
```
