...
- executáveis e runtimes adicionais são resolvidos dentro do próprio pacote, nunca pelo `PATH`, e o teste prova que o usuário não precisa instalar software além do ContentFlow;
