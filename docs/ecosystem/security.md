...
Os limites e o ciclo comum para bytes, MIME, dimensão, duração, redirects e materialização imediata de CDN estão em [`automation-media-conventions.md`](automation-media-conventions.md). O pacote pode reduzir esses limites, nunca ampliá-los silenciosamente.
